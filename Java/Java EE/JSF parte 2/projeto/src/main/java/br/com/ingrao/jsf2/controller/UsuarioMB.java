...
import br.com.ingrao.jsf2.dao.UsuarioDAO;
...
public class UsuarioMB implements Serializable {
	...
	public String acessar() {
		if (!existe(usuario)) {
			...
			context.getExternalContext().getSessionMap().put("usuarioLogado", this.usuario);// colocando no http o																							// usuario e seus dados
