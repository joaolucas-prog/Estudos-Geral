...
//Outra forma de organizar as querys é fazendo com que a entity reconheca ela usando o NamadQuery
@NamedQuery(name = "somaValor",query = "select sum(m.valor) from Movimentacao m")
...
public class Movimentacao {
	...
	public String toString() {
		return descricao + " - " + tipoMovimentacao;
	}
