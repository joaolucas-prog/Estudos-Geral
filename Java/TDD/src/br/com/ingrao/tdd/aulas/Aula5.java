...
public class Aula5 {
	...
	public void nãoDeveAvaliarLeiloesSemLanceDado() {
		Leilao leilao = new CriadordeLeilao().para("PS5 novo").constroi();	
	...
	@Test
	public void naoDeveAceitarUmLanceMenorQueAnterior() {
